  ...
  return (
    <div className="relative">
      ...
      <Button
        variant="outline"
        size="icon"
        className="absolute -left-4 top-1/2 -translate-y-1/2 rounded-full bg-white hover:bg-gray-50 border-gray-200 text-gray-600 shadow-lg z-10 h-9 w-9"
        aria-label="Previous"
      ...
      <Button
        variant="outline"
        size="icon"
        className="absolute -right-4 top-1/2 -translate-y-1/2 rounded-full bg-white hover:bg-gray-50 border-gray-200 text-gray-600 shadow-lg z-10 h-9 w-9"
        aria-label="Next"
        onClick={handleNext}
      >
      ...
      <Card className={`relative overflow-hidden bg-white border border-gray-200 rounded-xl p-4 md:p-6 text-gray-900 w-full transition-transform duration-200 ease-out shadow-lg hover:shadow-xl hover:border-[#0e241f]/20 ${
      ...
      <div className="relative flex flex-col md:flex-row md:items-center gap-6 md:gap-8">
        ...
        <div className="relative md:w-[48%] overflow-hidden rounded-lg">
          ...
          <div className="relative p-4 z-10">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-gray-500 text-xs font-mono">Dec 24</span>
            </div>

            {/* Compact headline with asset info */}
            <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-md overflow-hidden shrink-0 flex items-center justify-center border border-gray-200 bg-white">
                <Image 
              ...
              <h1 className="text-lg md:text-2xl font-black leading-tight tracking-tight text-gray-900">
            ...
            <div className="space-y-3 mb-4">
              <div className="flex items-center gap-3">
                <div className="text-gray-600 text-sm w-24 shrink-0">Will Profit</div>
                <div className="flex-1 flex items-center gap-3">
                  <Progress 
                    value={currentPosition.odds.profit} 
                    className="h-2 bg-gray-200 [&>div]:from-emerald-500 [&>div]:to-emerald-400" 
                  />
                  <div className="text-lg md:text-xl font-bold text-gray-900 tabular-nums">
                    {currentPosition.odds.profit}%
                  </div>
                </div>
                <div className="flex items-center gap-1">
                  <Button size="sm" variant="outline" className="h-7 px-3 bg-white border-emerald-200 text-emerald-700 hover:bg-emerald-50 hover:border-emerald-300 rounded-full flex items-center gap-1">
                    <Check className="h-3.5 w-3.5" /> Yes
                  </Button>
                  <Button size="sm" variant="outline" className="h-7 px-3 bg-white border-red-200 text-red-700 hover:bg-red-50 hover:border-red-300 rounded-full flex items-center gap-1">
              ...
              <div className="flex items-center gap-3">
                <div className="text-gray-600 text-sm w-24 shrink-0">Will Lose</div>
                <div className="flex-1 flex items-center gap-3">
                  <Progress 
                    value={currentPosition.odds.loss} 
                    className="h-2 bg-gray-200 [&>div]:from-red-500 [&>div]:to-rose-400" 
                  />
                  <div className="text-lg md:text-xl font-bold text-gray-700 tabular-nums">
        ...
        {/* Vertical divider between columns */}
          <div className="hidden md:flex w-px self-stretch bg-gradient-to-b from-transparent via-gray-300 to-transparent" />
        ...
        <div className="md:w-[52%] flex flex-col justify-center">
          ...
          <div className="mx-auto max-w-[420px] flex items-center justify-center gap-4 md:gap-6 mb-2 md:mb-3 text-[11px] md:text-xs text-gray-600">
          ...
          <div className="mb-3" />
           ...
           <div className="hidden md:flex justify-center mb-3">
            <div className="h-px w-1/2 bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
          </div>
            ...
            <ChartContainer config={chartConfig} className="h-full w-full mx-auto max-w-[420px]">
              <LineChart data={chartData} margin={{ top: 6, right: 32, left: 32, bottom: 16 }}>
                <XAxis 
                  ...
                  axisLine={false}
                  tickLine={false}
                  tick={{ fontSize: 10, fill: 'rgba(75,85,99,0.8)' }}
                  tickMargin={10}
